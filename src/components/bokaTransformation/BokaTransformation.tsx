...
const BokaTransformation = () => {
  return (
    <div className={`px-6 lg:px-[155px] py-[20px] bg-bgTrans`}>
      ...
      <div className='flex flex-col lg:flex-row items-center gap-[60px] '>
        ...
        <div className='flex flex-col items-start gap-5 w-full lg:w-2/5'>
          <p className='text-[20px] text-businessTitle font-[400] w-4/5'>
            "I am so happy with my facial visits. Anna has truly changed my skin
            completely. I would recommend everyone and anyone to start doing
            facials with her. I have sensitive and acne-prone skin, and I always
            leave Anna’s feeling fantastic. 10 stars!!!"
          </p>
          <div className='ml-4'>
